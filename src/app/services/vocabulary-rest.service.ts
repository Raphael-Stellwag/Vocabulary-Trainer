...
export class VocabularyRestService {
    ...
    private performAction(element: IAction, method: ActionMethod) {
        switch (method) {
            case ActionMethod.ADD:
                return this.dbFunctions.addVoc(element.vocabularyAfterAction);
                break;
            case ActionMethod.UPDATE:
                return this.dbFunctions.updateVoc(element.vocabularyAfterAction);
                break;
            case ActionMethod.DELETE:
                return this.dbFunctions.deleteVoc(element.vocabularyBeforeAction);
                break;
        }
    }
    ...
    private performReverseAction(element: IAction, method: ActionMethod): Promise<any> {
        switch (method) {
            case ActionMethod.ADD:
                return this.dbFunctions.deleteVoc(element.vocabularyAfterAction);
                break;
            case ActionMethod.UPDATE:
                return this.dbFunctions.updateVoc(element.vocabularyBeforeAction);
                break;
            case ActionMethod.DELETE:
                return this.dbFunctions.addVoc(element.vocabularyBeforeAction);
                break;
        }
    }
